...
@FindBy(id="container_tasks")public WebElement Task_lnk;
@FindBy(xpath = "//span[text()='Customers & Projects']")
public WebElement validateCustomer_txt;;

@FindBy(xpath="//div[@class='rightContainer']/div/div/table")public WebElement Searchfun_box;
@FindBy(id="logoutLink")public WebElement Logout_lnk;
@FindBy(id="logo_aT") public WebElement Logo;

@FindBy(xpath="//div[@class='menuTable']/div[2]")public WebElement settings_lnk;
@FindBy(xpath="//a[text()='Notifications']")public WebElement Notification_lnk;
@FindBy(xpath="//a[@class='userProfileLink username ']")public WebElement Profile_lnk;	
@FindBy(xpath="//span[text()='My Profile']")public WebElement validateProfile;
@FindBy(id="closeUserProfilePopupButton")public WebElement CloseProfile;
